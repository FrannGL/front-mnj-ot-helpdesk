...
import { isExternalLink } from 'src/shared/utils/utils';
...
import { useEventListener } from 'src/shared/hooks/minimal/use-event-listener';
import { SearchNotFound } from 'src/shared/components/minimal/search-not-found';
